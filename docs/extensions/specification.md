...
- **#549:** declared actions.
  ...
  - Preconditions ([#550](https://github.com/srelens/srelens/issues/550)), migrating the core Flux and Argo CD actions into manifests ([#551](https://github.com/srelens/srelens/issues/551)) and the host-owned confirmation ([#552](https://github.com/srelens/srelens/issues/552)) are not in this release. `extensions.action` and the host's own `supported_actions` table are unchanged.
