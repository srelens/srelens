...
The extension documentation has moved to [docs/extensions](extensions/introduction.md):

- [Introduction](extensions/introduction.md): what apps are and how to try one
- [Specification](extensions/specification.md): versioning, compatibility, identifiers, API changelog
