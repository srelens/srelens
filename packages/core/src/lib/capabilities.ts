...
export const HOST_ONLY_CAPABILITY_IDS: readonly string[] = [
  "settings.get", "settings.set", "extensions.catalog", "extensions.catalogManifest", "extensions.list", "extensions.configure", "extensions.validate", "extensions.read", "extensions.resolveColumns", "extensions.resolveCards", "extensions.resource", "extensions.action",
];
