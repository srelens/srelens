...
mod tests {
    ...
    async fn local_extension_inventory_and_execution_are_denied_on_web() {
        for id in ["extensions.resource", "extensions.action", "extensions.catalog", "extensions.catalogManifest", "extensions.validate", "extensions.list", "extensions.configure", "extensions.read", "extensions.resolveColumns", "extensions.resolveCards", "extensions.resolvePanels", "extensions.resolveLinks"] {
